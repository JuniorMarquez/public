...
//  $http.get('http://localhost:1346/electoral').success(function(respuesta){
//  		$scope.electoral = respuesta.results;
//       });
// $http.get('http://localhost:1346/directiva').success(function(respuesta){
//  		$scope.directiva = respuesta.results;
//       });
// $http.get('http://localhost:1346/comite').success(function(respuesta){
//  		$scope.comite = respuesta.results;
//       });
// $http.get('http://localhost:1346/deporte').success(function(respuesta){
